...
export const FACET_EVIDENCE_SOURCE: FacetEvidenceSource = {
  ...
  placement: {
    ...
    source_acceptance_pending: 'current',
    rollout_authorization_pending: 'current',
    rollout_authorization_stale: 'current',
    preflight_blocked: 'current',
  },
  rollout: {
    not_applicable: 'not_applicable',
    ...
    rollout_queued: 'current',
    canary_in_progress: 'future',
    batch_in_progress: 'future',
    fully_deployed_health_pending: 'current',
    configuration_converged_artifact_qualified: 'current',
    exactly_converged_healthy: 'current',
    rollout_superseded: 'current',
  },
  runtime: {
    tombstoned: 'current',
    recovery_required: 'current',
