...
describe('describeProbeFailure', () => {
    ...
    it.each([
        ['no_route', /not published right now/, null],
...
describe('describeMembershipError', () => {
    ...
    it('explains a data plane problem', () => {
        expect(describeMembershipError(503, 'subnet_overlap')).toBe('Mesh is not ready on this node: subnet_overlap');
    });
