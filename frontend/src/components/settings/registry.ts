...
export const SETTINGS_ITEMS: readonly SettingsItemMeta[] = [
    ...
    },
    {
        ...
        group: 'personal',
        label: 'Appearance',
        description: 'Visual style, readability, theme, accent, charts, pane layout, and navigation preferences saved to your account.',
        keywords: ['theme', 'dim', 'oled', 'light', 'dark', 'accent', 'color', 'glow', 'border', 'contrast', 'density', 'comfortable', 'compact', 'spacing', 'display', 'calm', 'signature', 'readability', 'heading', 'chart', 'motion', 'effects', 'navigation', 'smart', 'launcher', 'quick links', 'topbar', 'top nav', 'sync', 'account', 'sidebar', 'anatomy', 'stack detail', 'resize', 'resizable', 'pane', 'width', 'layout'],
        tier: null,
        scope: 'account',
    },
    // Access
    ...
    },
    {
        ...
        keywords: ['stack', 'compose', 'deploy', 'guardrail', 'health gate', 'observation', 'env', 'required variable', 'progress', 'modal', 'inline', 'diff', 'preview', 'save', 'editor', 'workflow', 'rollback', 'retention', 'generation', 'git', 'gitops', 'polling', 'poll interval', 'suspend', 'resume', 'retry'],
        tier: null,
        scope: 'node',
    },
    {
