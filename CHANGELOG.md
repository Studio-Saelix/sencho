...
## [0.98.0](https://github.com/Studio-Saelix/sencho/compare/v0.97.1...v0.98.0) (2026-09-26)


### Added

* add canonical tier catalog with cross-repo drift detection ([#1873](https://github.com/Studio-Saelix/sencho/issues/1873)) ([9940efb](https://github.com/Studio-Saelix/sencho/commit/9940efb94f195a2757e3e509925fc9e36143275a))
* **blueprints:** detect and enforce runtime digest drift ([#1949](https://github.com/Studio-Saelix/sencho/issues/1949)) ([489e1a9](https://github.com/Studio-Saelix/sencho/commit/489e1a9a9a909d90f798bbecd74d55fc2cf32cf6))
* **dashboard:** rebalance the Home lower half around operational signals ([#1953](https://github.com/Studio-Saelix/sencho/issues/1953)) ([0ab2652](https://github.com/Studio-Saelix/sencho/commit/0ab26529d304cb172546e01608e037d20708110d))
* **dashboard:** Stack Health All nodes inventory ([#1918](https://github.com/Studio-Saelix/sencho/issues/1918)) ([a375861](https://github.com/Studio-Saelix/sencho/commit/a3758617168c097e08f52e9ea5c5b9782ad4bc31))
* deliver hub registry credentials to remote Compose targets ([#1866](https://github.com/Studio-Saelix/sencho/issues/1866)) ([341511a](https://github.com/Studio-Saelix/sencho/commit/341511a2e02a340f6d87eef2670acb69faac501c)), thanks @samschultzponsys
* **fleet:** detect and update from a new sencho-dev:dev build ([#1871](https://github.com/Studio-Saelix/sencho/issues/1871)) ([275c654](https://github.com/Studio-Saelix/sencho/commit/275c654407d44d6af0dbf4b7a2c8deed3f24695a))
* **fleet:** replace the Status tab with Readiness ([#1952](https://github.com/Studio-Saelix/sencho/issues/1952)) ([1efaa13](https://github.com/Studio-Saelix/sencho/commit/1efaa1349265de912b12a830d709170cb1d0a462))
* **git:** add GitOps revision store and Direct apply transitions ([#1835](https://github.com/Studio-Saelix/sencho/issues/1835)) ([38ee452](https://github.com/Studio-Saelix/sencho/commit/38ee4527b1289f9a05d0bfb0e069a900804620e4))
* **git:** classify Git host rate-limit responses as their own error state ([#1884](https://github.com/Studio-Saelix/sencho/issues/1884)) ([1bcf7b5](https://github.com/Studio-Saelix/sencho/commit/1bcf7b5f366424dd69944520f8375f3968480ee7))
...
* GitOps executable artifact identity (Direct nodes) ([#1937](https://github.com/Studio-Saelix/sencho/issues/1937)) ([a698b6d](https://github.com/Studio-Saelix/sencho/commit/a698b6d98337cdde220627c1585e6c29b6d05715))
* **gitops:** add decomposed approval actions for Git-managed Blueprints ([#1959](https://github.com/Studio-Saelix/sencho/issues/1959)) ([b27fbee](https://github.com/Studio-Saelix/sencho/commit/b27fbeeb46e9488603641feb50f860b4538b019b))
* **gitops:** add rollout generations and Inline placement approval ([20d0db4](https://github.com/Studio-Saelix/sencho/commit/20d0db4691d68ee56857237bd8aa6ab673fc85b1))
* **gitops:** add rollout lifecycle controls and rollback recovery ([#1965](https://github.com/Studio-Saelix/sencho/issues/1965)) ([bb85e08](https://github.com/Studio-Saelix/sencho/commit/bb85e08b3657b938405a67400bdd2dbdc3adaeed))
* **gitops:** add the GitOps portfolio workplace ([#1954](https://github.com/Studio-Saelix/sencho/issues/1954)) ([85f5246](https://github.com/Studio-Saelix/sencho/commit/85f5246445a1239093b26c0921a43b9bde60a06d))
* **gitops:** authorize Git-managed Blueprint rollout generations ([9cbb5f8](https://github.com/Studio-Saelix/sencho/commit/9cbb5f8cebbe2e60e2dd090d56f7219fc803e72e))
* **gitops:** bind Blueprint content to a live Git source ([#1926](https://github.com/Studio-Saelix/sencho/issues/1926)) ([ea905b7](https://github.com/Studio-Saelix/sencho/commit/ea905b758bb879a24d39f65ce08bdd6752a8fb94)), thanks @samschultzponsys
* **gitops:** block Blueprint place until private registry targets are ready ([#1946](https://github.com/Studio-Saelix/sencho/issues/1946)) ([2fb2c91](https://github.com/Studio-Saelix/sencho/commit/2fb2c9116cdfc367227968d0d182551cb3b07e5d))
* **gitops:** compose the authority evidence into the Blueprint rollout preview ([#1957](https://github.com/Studio-Saelix/sencho/issues/1957)) ([a881e42](https://github.com/Studio-Saelix/sencho/commit/a881e425f803d47ab0b399938c46cc3c71073dce))
* **gitops:** connect the workplace to stacks, Git sources, Blueprints, and Fleet ([#1978](https://github.com/Studio-Saelix/sencho/issues/1978)) ([13690c0](https://github.com/Studio-Saelix/sencho/commit/13690c01d25efdd8a440d1de393b440144cb3fd1))
* **gitops:** dispatch accepted generations through the shared pipeline ([#1913](https://github.com/Studio-Saelix/sencho/issues/1913)) ([3f91705](https://github.com/Studio-Saelix/sencho/commit/3f917059ecc03318793f6128bee56fca5fbb4b7f))
* **gitops:** durable reconcile-attempt reservation, coalescing, and recovery ([#1893](https://github.com/Studio-Saelix/sencho/issues/1893)) ([69e7609](https://github.com/Studio-Saelix/sencho/commit/69e76090ccc6c7ef9a2b358de4bf4c6bbaa746fc))
* **gitops:** harden the portfolio workplace and scope stack indicators ([#1977](https://github.com/Studio-Saelix/sencho/issues/1977)) ([09494d2](https://github.com/Studio-Saelix/sencho/commit/09494d2f952bf12d7d78cb7a7a83b2ff6b71f5d9))
* **gitops:** native Git provider webhook ingestion ([#1934](https://github.com/Studio-Saelix/sencho/issues/1934)) ([e62b059](https://github.com/Studio-Saelix/sencho/commit/e62b059abf31c1f0fe25833d91ccc50058fcd5ef))
* **gitops:** notify on authority, rollout, and stateful-hold decisions ([#1969](https://github.com/Studio-Saelix/sencho/issues/1969)) ([48b0276](https://github.com/Studio-Saelix/sencho/commit/48b0276fabcde776267c622a6808938f322506ae))
* **gitops:** open each portfolio application in a read-only application view ([#1956](https://github.com/Studio-Saelix/sencho/issues/1956)) ([46937e7](https://github.com/Studio-Saelix/sencho/commit/46937e7db15a5e50996b21fa3aaaee2005f59a66))
* **gitops:** poll scheduling, source policies, and retry evidence ([#1910](https://github.com/Studio-Saelix/sencho/issues/1910)) ([57cd842](https://github.com/Studio-Saelix/sencho/commit/57cd8422fb5c5ef8465e7e00ce1b3e0a509a173f))
* **gitops:** produce the remaining drift classes ([#1979](https://github.com/Studio-Saelix/sencho/issues/1979)) ([698d3f3](https://github.com/Studio-Saelix/sencho/commit/698d3f34bc251c9b2613dcf8f86fc40bd2750714))
* **gitops:** render decomposed approval authority and placement/rollout state ([#1955](https://github.com/Studio-Saelix/sencho/issues/1955)) ([5981355](https://github.com/Studio-Saelix/sencho/commit/5981355c27c0dc14acd2e7a581d0266f33d2a378))
* **gitops:** resolve branch, tag, and SHA refs to immutable commits before fetch ([#1864](https://github.com/Studio-Saelix/sencho/issues/1864)) ([48f0104](https://github.com/Studio-Saelix/sencho/commit/48f010475be7badb5bd61882bc9fbc3269ab8cc2))
* **gitops:** show per-target image digests and document the drift model ([#1984](https://github.com/Studio-Saelix/sencho/issues/1984)) ([61b25f4](https://github.com/Studio-Saelix/sencho/commit/61b25f48d240f2389608d5297981b3960fd78766))
* **gitops:** SOPS/age repository secrets without durable plaintext ([#1935](https://github.com/Studio-Saelix/sencho/issues/1935)) ([9d0dbeb](https://github.com/Studio-Saelix/sencho/commit/9d0dbebbfab845fe3e0312de4d3632b61a25f292))
* **gitops:** source controller follow-on ([#1920](https://github.com/Studio-Saelix/sencho/issues/1920)) ([71595cb](https://github.com/Studio-Saelix/sencho/commit/71595cb1ce8a45806964fba741af554746aa5b24))
* **gitops:** stage-aware retry and resume re-evaluation ([#1917](https://github.com/Studio-Saelix/sencho/issues/1917)) ([d4ef263](https://github.com/Studio-Saelix/sencho/commit/d4ef263d6e2eb58ebcb475d266bfb45d59fd2104))
* **git:** per-source private CA bundles and redirect credential guard ([#1870](https://github.com/Studio-Saelix/sencho/issues/1870)) ([d5ef403](https://github.com/Studio-Saelix/sencho/commit/d5ef403f67fdda3268c457eae6743439fdcd6486))
* **git:** SSH deploy keys with strict host-key verification ([#1867](https://github.com/Studio-Saelix/sencho/issues/1867)) ([3ca0f8e](https://github.com/Studio-Saelix/sencho/commit/3ca0f8e5d481a91d074884e41de5b6f982d0747a))
* **git:** swap isomorphic-git for native git transport behind clone seam ([#1849](https://github.com/Studio-Saelix/sencho/issues/1849)) ([392bc15](https://github.com/Studio-Saelix/sencho/commit/392bc15d913bc61e2c6ab058f9d15d9deb940c04))
* listen with HTTPS so Pilot credential delivery stays confidential ([#1943](https://github.com/Studio-Saelix/sencho/issues/1943)) ([c02dfa4](https://github.com/Studio-Saelix/sencho/commit/c02dfa4fddd8d3deb9230addc5d613272f361ef0))
* **navigation:** make Compact Launcher the default desktop style ([#1890](https://github.com/Studio-Saelix/sencho/issues/1890)) ([b676657](https://github.com/Studio-Saelix/sencho/commit/b6766572df93beebea3021c4ec12bf622efe7a3d))
...
* **preferences:** server-backed per-user appearance and navigation ([#1901](https://github.com/Studio-Saelix/sencho/issues/1901)) ([e7b457f](https://github.com/Studio-Saelix/sencho/commit/e7b457f45603b00590a26cca6ffdd7306cbcd78b))
...
* **registry:** exact-ref private-registry delivery to remote nodes ([#1905](https://github.com/Studio-Saelix/sencho/issues/1905)) ([ce8b454](https://github.com/Studio-Saelix/sencho/commit/ce8b4546002081955fdccdf772db79c5ea7fc845))
* **registry:** Pilot private-registry parity - target facts, hub authority, auto-update ([#1930](https://github.com/Studio-Saelix/sencho/issues/1930)) ([39e0af9](https://github.com/Studio-Saelix/sencho/commit/39e0af9fa7a61147f1be091c04edd9c5fb4e6069))
* **registry:** seal private-registry credentials for HTTP delivery ([#1945](https://github.com/Studio-Saelix/sencho/issues/1945)) ([591b062](https://github.com/Studio-Saelix/sencho/commit/591b06220bd72ae67ae9c884648d2a115c563a3a)), thanks @samschultzponsys
...
* **ui:** add resizable sidebar and Anatomy pane ([#1902](https://github.com/Studio-Saelix/sencho/issues/1902)) ([ab6e494](https://github.com/Studio-Saelix/sencho/commit/ab6e4940e7b7252d73774816e060835fb6db8ea8)), thanks @candroid-man
...
* calm shared modal open/close motion ([#1931](https://github.com/Studio-Saelix/sencho/issues/1931)) ([7569f1d](https://github.com/Studio-Saelix/sencho/commit/7569f1d763bdb15e47467b7df683ec1db18a2a2b))
* **catalog:** use js-yaml namespace import for ESM v5 ([#1942](https://github.com/Studio-Saelix/sencho/issues/1942)) ([a53fc42](https://github.com/Studio-Saelix/sencho/commit/a53fc42b86c958a30decaee4b493c5952c86791d))
* **console:** clarify Pilot Agent host-console unavailability ([#1868](https://github.com/Studio-Saelix/sencho/issues/1868)) ([4994031](https://github.com/Studio-Saelix/sencho/commit/49940311badfa068b2f41c0e4bd7fa25635cb1a1)), closes [#1855](https://github.com/Studio-Saelix/sencho/issues/1855), thanks @samschultzponsys
* **dashboard:** use balloon-adjusted memory percent on the Memory tile ([#1847](https://github.com/Studio-Saelix/sencho/issues/1847)) ([c3c6c1b](https://github.com/Studio-Saelix/sencho/commit/c3c6c1b0c10c2312a7f67f628748ffd8411d6a25)), thanks @Crosis47
* **db:** log failed column migrations and cover poll-column upgrades ([#1976](https://github.com/Studio-Saelix/sencho/issues/1976)) ([39e1325](https://github.com/Studio-Saelix/sencho/commit/39e132512f84798ec58acfe3997be72f37bd47e8)), thanks @samschultzponsys
* **deps:** bump grpc-go to v1.83.1 to clear CVE-2026-84304 ([#1885](https://github.com/Studio-Saelix/sencho/issues/1885)) ([3cfa8ab](https://github.com/Studio-Saelix/sencho/commit/3cfa8abf6a48185e0317dbc71e497c91e908bc05))
* **deps:** bump grpc-go to v1.83.2 ([72fd455](https://github.com/Studio-Saelix/sencho/commit/72fd455346ff0436adce2f61390eabaf543d22bf))
* **deps:** bump transitive deps to clear fast-uri, qs, and humanfs advisories ([#1891](https://github.com/Studio-Saelix/sencho/issues/1891)) ([f8cfcb5](https://github.com/Studio-Saelix/sencho/commit/f8cfcb547afa29ba8691fa82cc1b318e25a70155))
* **e2e:** read the launcher morph after the transition settles ([#1971](https://github.com/Studio-Saelix/sencho/issues/1971)) ([1990131](https://github.com/Studio-Saelix/sencho/commit/199013197eb67e5e264dfe0ecf3e18da687dc652))
* **e2e:** ride out the shared API limiter in the sidebar truncation spec ([#1958](https://github.com/Studio-Saelix/sencho/issues/1958)) ([4453ca5](https://github.com/Studio-Saelix/sencho/commit/4453ca552e9ebb8c40ea66df8e5ed192199f37b7))
* **e2e:** stop a failed two-factor spec from cascading the whole suite ([#2009](https://github.com/Studio-Saelix/sencho/issues/2009)) ([3f2b534](https://github.com/Studio-Saelix/sencho/commit/3f2b5348be8679561c10c0ce8da61c34f1b69057))
...
* **editor:** pin compose editor requests to the captured node ([#1897](https://github.com/Studio-Saelix/sencho/issues/1897)) ([607904e](https://github.com/Studio-Saelix/sencho/commit/607904ee639f7f772a5cb00b7eb24b3368bcf164)), thanks @samschultzponsys
* **exec:** fall back to /bin/sh when a container has no bash ([#1997](https://github.com/Studio-Saelix/sencho/issues/1997)) ([e1c044d](https://github.com/Studio-Saelix/sencho/commit/e1c044d05bd5e4ce36688f601162421cd0c1cd62))
* **fleet:** bound unreachable proxy overview probes ([#1919](https://github.com/Studio-Saelix/sencho/issues/1919)) ([e8da1fd](https://github.com/Studio-Saelix/sencho/commit/e8da1fd64b01fd3e6a30207d18b99bd0c001c88c))
* **fleet:** stop advertising a dev build the node already applied ([#1974](https://github.com/Studio-Saelix/sencho/issues/1974)) ([1347bca](https://github.com/Studio-Saelix/sencho/commit/1347bca5e55130f90f0b81a518e840c07a0ef04d))
...
* **frontend:** stop client-side preference changes refetching all settings ([#2008](https://github.com/Studio-Saelix/sencho/issues/2008)) ([bcc4b7e](https://github.com/Studio-Saelix/sencho/commit/bcc4b7e00a95ecc6d3dfdf03308c276c9d7a6218))
* **gitops:** fail closed on incomplete target evidence ([#1998](https://github.com/Studio-Saelix/sencho/issues/1998)) ([b4d01da](https://github.com/Studio-Saelix/sencho/commit/b4d01da7009e9c475011aac09f7f4336808b2a31))
* **gitops:** guard automatic acceptance against stateful withdrawal ([#1975](https://github.com/Studio-Saelix/sencho/issues/1975)) ([3ecb954](https://github.com/Studio-Saelix/sencho/commit/3ecb954f282d778b72da01bf67ee331c4ca3fc28))
* **gitops:** name the unresolved artifact identity and drop the stale source report ([#1960](https://github.com/Studio-Saelix/sencho/issues/1960)) ([7767fd6](https://github.com/Studio-Saelix/sencho/commit/7767fd6f93287c68df0b0fe7ae9aeca8ee52f6ae))
* **gitops:** prune provider webhook endpoints when a git source or stack is removed ([#1940](https://github.com/Studio-Saelix/sencho/issues/1940)) ([23baec2](https://github.com/Studio-Saelix/sencho/commit/23baec2a7d5a6746d653583e5c1267c05755065b))
* **gitops:** render the portfolio Rollout column through the rollout vocabulary ([#1970](https://github.com/Studio-Saelix/sencho/issues/1970)) ([38de9b6](https://github.com/Studio-Saelix/sencho/commit/38de9b6d361e185228e2efee627eb8fafb49053e))
* **gitops:** return reconciliation results from manual pulls ([#1927](https://github.com/Studio-Saelix/sencho/issues/1927)) ([e41722d](https://github.com/Studio-Saelix/sencho/commit/e41722db5689c2ae002535d8cd7796a93ac384c9))
* **hub-only:** enforce hub-only /api/api-tokens/ boundary ([#1894](https://github.com/Studio-Saelix/sencho/issues/1894)) ([6fc4a43](https://github.com/Studio-Saelix/sencho/commit/6fc4a43a04a740785988634c68f34b19c6da4970))
...
* **networking:** hold unsafe network deletions and stabilize aggregate reads ([#1850](https://github.com/Studio-Saelix/sencho/issues/1850)) ([cc4a657](https://github.com/Studio-Saelix/sencho/commit/cc4a6571c7b672b1b2269b2d7f5dadccc9df4a7d))
* **nodes:** reject whitespace-only names on create ([#1911](https://github.com/Studio-Saelix/sencho/issues/1911)) ([0a6d0bf](https://github.com/Studio-Saelix/sencho/commit/0a6d0bf7faa16decfbcc39246c0ac7bc100e4d6d))
* **notifications:** redact webhook URLs on channel reads ([#1951](https://github.com/Studio-Saelix/sencho/issues/1951)) ([2baf4e3](https://github.com/Studio-Saelix/sencho/commit/2baf4e32ee717606294a144a768b969a66cd5c3d))
...
* preserve exact guardrail message for Save & Deploy and Start ([#1898](https://github.com/Studio-Saelix/sencho/issues/1898)) ([30e3936](https://github.com/Studio-Saelix/sencho/commit/30e39368abb259d76875b7e5fe53a3e67b5f6273))
* **proxy:** resolve node id consistently before deciding to bypass json parsing ([#1880](https://github.com/Studio-Saelix/sencho/issues/1880)) ([8d9522c](https://github.com/Studio-Saelix/sencho/commit/8d9522c54f1b9089615314aee7679c965dd72476))
* **resources:** zero reclaimable images when held state is unknown ([#1912](https://github.com/Studio-Saelix/sencho/issues/1912)) ([4b2f9aa](https://github.com/Studio-Saelix/sencho/commit/4b2f9aad9892b682c20bd2ed767e32c9b9e55b98))
* **security:** harden authentication and outbound targets ([#1877](https://github.com/Studio-Saelix/sencho/issues/1877)) ([79b86dd](https://github.com/Studio-Saelix/sencho/commit/79b86ddcd4aefdd6941f098e35990ab397b13c72))
...
* **sso:** enforce hub-only SSO config when remote node is active ([#1865](https://github.com/Studio-Saelix/sencho/issues/1865)) ([c6d9fb9](https://github.com/Studio-Saelix/sencho/commit/c6d9fb98e5f2fb421147427324617fc9620f2e87)), thanks @samschultzponsys
* **sso:** preserve admin-assigned roles across SSO sign-in ([#1862](https://github.com/Studio-Saelix/sencho/issues/1862)) ([7cd4269](https://github.com/Studio-Saelix/sencho/commit/7cd42699d1b0e3427dd872c2c93d6c15f2f0b11a)), thanks @samschultzponsys
* **sso:** preserve granular roles across enabled role synchronization ([#1875](https://github.com/Studio-Saelix/sencho/issues/1875)) ([8cf10c4](https://github.com/Studio-Saelix/sencho/commit/8cf10c45f0e954a0b7e1ef87bb7558b730fba74e))
...
* stop compose-ps spam after deleting a stack ([#1831](https://github.com/Studio-Saelix/sencho/issues/1831)) ([4c93947](https://github.com/Studio-Saelix/sencho/commit/4c93947004ff0e141c4a3aa96356106430e97888)), thanks @proofquantu
* **terminal:** support copy and paste in container and host consoles ([#1996](https://github.com/Studio-Saelix/sencho/issues/1996)) ([423f4e9](https://github.com/Studio-Saelix/sencho/commit/423f4e9f11bf9ca9e68aabeffd990c9f7574ddb0)), closes [#1988](https://github.com/Studio-Saelix/sencho/issues/1988), thanks @samschultzponsys
* **ui:** polish modal footer, quick-link removal, and empty Recent alerts ([#1973](https://github.com/Studio-Saelix/sencho/issues/1973)) ([8ff0f51](https://github.com/Studio-Saelix/sencho/commit/8ff0f51a1bf5a169895c7fadfb8007aa18616cbe))
* **ui:** prevent modal footer overflow and keep a viewport gutter ([#1928](https://github.com/Studio-Saelix/sencho/issues/1928)) ([a82cf5e](https://github.com/Studio-Saelix/sencho/commit/a82cf5e42d4c6b8f0bed0e9fb4a503daab986ce8))
* **ui:** tighten Stack Health row semantics and resizable pane affordances ([#1972](https://github.com/Studio-Saelix/sencho/issues/1972)) ([fc6cc62](https://github.com/Studio-Saelix/sencho/commit/fc6cc62a27dd1ff55c2e25d7a5b31810c4a7f3b7))
* **ui:** wrap modal titles on word boundaries ([#1950](https://github.com/Studio-Saelix/sencho/issues/1950)) ([6345e69](https://github.com/Studio-Saelix/sencho/commit/6345e695c4588ad1626f98574982d43298feb2d6))
* untag reviewed image names during prune ([#1836](https://github.com/Studio-Saelix/sencho/issues/1836)) ([01ffbdb](https://github.com/Studio-Saelix/sencho/commit/01ffbdbfc7f1b8886e6653300556b5a835f9b98f)), thanks @Crosis47
...
* account for VM memory ballooning in host memory reporting ([#1750](https://github.com/Studio-Saelix/sencho/issues/1750)) ([c613010](https://github.com/Studio-Saelix/sencho/commit/c613010199fc67b21f940a379fbe3d801f0d36a4)), thanks @Crosis47
...
* **fleet:** show itemized prune plans ([#1734](https://github.com/Studio-Saelix/sencho/issues/1734)) ([44d6078](https://github.com/Studio-Saelix/sencho/commit/44d607824113a6bca9723978f7200492c9e28736)), thanks @Crosis47
...
* surface ZFS ARC reclaimable as dashboard context line ([#1760](https://github.com/Studio-Saelix/sencho/issues/1760)) ([71be163](https://github.com/Studio-Saelix/sencho/commit/71be1634a5b6214d39ee9159eadf4151a85500c8)), thanks @Crosis47
...
* **networking:** ignore verified Mesh attachments in drift ([#1729](https://github.com/Studio-Saelix/sencho/issues/1729)) ([3c93406](https://github.com/Studio-Saelix/sencho/commit/3c934066f3d49d5850a42475821a2d47dbf52b2e)), thanks @Crosis47
