---
title: Introduction
description: The self-hosted Docker Compose dashboard for homelabs and fleet infrastructure.
---

Sencho is a self-hosted dashboard for Docker Compose. It turns the Compose projects on one Docker host, or across a fleet of hosts, into a single browser workspace for deploying stacks, editing configuration, watching health, cleaning up resources, and coordinating remote operations.
