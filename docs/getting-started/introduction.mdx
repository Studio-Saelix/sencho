...
Beyond **Overview**, Fleet provides tabs for **Snapshots**, node **Status**, a dependency **Map**, blueprint **Deployments**, mesh **Routing**, **Federation**, fleet **Actions**, and **Secrets**. Routing, Federation, and Secrets require Admiral. See [Licensing](/features/licensing) for the full tier breakdown.
