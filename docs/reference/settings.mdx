...
<Frame>
  <img src="/images/settings/settings-load-failure.png" alt="Settings section showing a load failure callout when the active node's settings could not be loaded" />
</Frame>
