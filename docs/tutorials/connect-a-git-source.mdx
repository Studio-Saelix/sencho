...
This tutorial covers linking an existing stack to a Git source and running one manual pull-review-apply cycle. It doesn't cover creating a brand-new stack directly from a repository, the three webhook-driven apply modes, polling, suspend, or multi-file compose sources; see the [Git Sources](/features/git-sources) feature page for all of that.
