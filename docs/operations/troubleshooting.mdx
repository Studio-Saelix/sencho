...
**Likely cause:** Full material effects (glass blur on the top bar, sidebar, and floating surfaces) cost more to composite on integrated graphics, single-board computers, and other constrained rendering devices. Discrete or high-performance GPUs often hide that cost. Fresh installs default to **Calm**, which already enables **Reduced effects**.
