...
1. **One-click install from Settings → Security → Vulnerability Scanning** (recommended). The same install, update, and auto-update controls are available on the [Security page](/features/security) **Scanner setup** tab.
