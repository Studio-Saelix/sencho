...
| Requirement | Detail |
|---|---|
| License tier | **Community** to read, create, edit, withdraw, and apply blueprints. **Admiral** to pin a blueprint to a specific node (Federation). |
| User role | **Admin** to create, edit, withdraw, accept, and apply. Operators and viewers can read the catalog and the detail sheet. Pinning requires admin on Admiral. |
