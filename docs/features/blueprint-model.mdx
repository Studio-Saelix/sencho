...
- source acceptance, placement approval, and rollout authorization for a Git-managed Blueprint;
...
Each entry names the Blueprint for a Git-managed Blueprint application (or the stack for a Direct application) and records the GitOps operation it came from. These categories are history-only: they appear in the bell, and they are not sent to your configured delivery channels.
