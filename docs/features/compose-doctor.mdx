...
| Healthcheck inherited from current image | Info | The Compose model does not declare a healthcheck, but the running container or a local image provides one. |
