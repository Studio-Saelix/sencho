...
<Frame>
  <img src="/images/deploy-progress/setting-toggle.png" alt="Settings Appearance Display panel showing the Deploy progress toggle and the Progress style Modal and Inline picker." />
</Frame>
