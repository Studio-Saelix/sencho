...
<Frame>
  <img src="/images/alerts-notifications/notifications-settings.png" alt="Settings · Notifications · Channels panel showing the Discord, Slack, Webhook, and Apprise tabs with the masthead breadcrumb, the CHANNELS 4/4 stat, the active Discord tab with its Enabled toggle on, the Webhook URL input, and the Test and Save actions." />
</Frame>
