...
<Frame>
  <img src="/images/alerts-notifications/notifications-settings.png" alt="Settings · Notifications · Channels panel showing a Delivery retries row with Extra attempts set to 0 and Save retries disabled, Discord Slack Webhook and Apprise tabs with Apprise selected, CHANNELS 0/4 in the masthead, Enabled off, an empty Apprise endpoint, and Test disabled beside Save." />
</Frame>
