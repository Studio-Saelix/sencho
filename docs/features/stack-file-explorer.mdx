...
<Frame>
  <img src="/images/stack-file-explorer/root-switcher.png" alt="The Browsing selector showing a Volumes group with the swag /config bind mount and a Stack source group" />
</Frame>
