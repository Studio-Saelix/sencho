...
The **global search palette** lets you move around Sencho without reaching for the mouse. It covers the destinations the top navigation strip exposes for your tier and role, every configured node, and every stack on every online node in your fleet.

<Frame>
  <img src="/images/global-search/palette-pages.png" alt="Sencho global search palette open with no query, the Pages group listing Home, Fleet, Resources, Security, App Store, and Logs each with a leading icon." />
</Frame>
