...
<Note>
  Crash healing acts on crashes Sencho observes while it is running. A container that crashed before Sencho started, or that has been down for a long time, is left for you to inspect rather than restarted automatically.
</Note>
