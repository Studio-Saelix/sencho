...
<Note>
  Scoped permissions require **Admiral**. On Skipper, the Scoped Permissions box does not render and the underlying `/api/users/:id/roles` endpoints reject writes.
</Note>
