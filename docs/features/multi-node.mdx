...
| Panel | Scope | Notes |
|-------|:-----:|-------|
| Appearance | Account | Theme, density, navigation, sidebar layout, and Anatomy panel layout preferences are saved to your account, not to the node. Changing the active node does not change your look. |
