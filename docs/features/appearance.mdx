...
- **Reduced motion** minimizes interface animations and transitions (dialogs, menus, expand and collapse). Toasts are unaffected. This is the first control to try for high idle GPU use on constrained graphics.
...
<Frame>
  <img src="/images/settings/appearance-display.png" alt="The Appearance Display section with a Density selector and a Log chip color control." />
</Frame>
...
- **Navigation style**
  ...
  - **Compact launcher**: puts destinations in a left-side launcher menu and optionally pins up to four **quick links** on the bar.
...
- **Quick links** (Compact launcher): lists pinned destinations, lets you remove them, and can reset to the recommended set. Use the **+** control on the top bar to pin the current eligible page when fewer than four pins are stored.
