...
- **Quick links** (Compact launcher): labeled pins after the launcher, with a trailing **+** that opens reachable unpinned destinations. Remove a pin from its actions menu on the bar, or manage the full list under Appearance. Up to five pins; recommended defaults start you with four.
