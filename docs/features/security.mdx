...
for the matching stack. Intentional public exposure still raises the security relevance of
vulnerable findings: open the image, remediate, or triage individual findings (Accepted risk and
related decisions). There is no image-level "accept residual risk" control. Compose Doctor
acknowledgements are a separate triage surface and do not clear Security exposure posture. Selecting
