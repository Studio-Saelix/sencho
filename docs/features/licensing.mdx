...
Sencho is [AGPLv3](https://github.com/studio-saelix/sencho/blob/main/LICENSE) open source. **Community** is the complete self-hosted Compose-first control plane in this public repository, free forever with unlimited nodes. **Admiral** is Studio Saelix business assurance (priority support, managed continuity, governance depth, and release assurance) delivered as a paid plan; Admiral software and managed services are developed privately by Studio Saelix and are not part of the public contribution surface.
...
Admiral plan software and managed services are maintained in private Studio Saelix repositories. The public Sencho repository is the Community product.
