...
- Blueprints: fleet-wide compose templates with drift detection (Observe, Suggest, and Enforce) and reconciliation
...
- **Fleet operations:** node cordon and Sencho Mesh (cross-node container networking)
