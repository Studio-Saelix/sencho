...
<Note>
  Saving the form clears any staged commit, because the plan was built against the settings you just changed. The state moves to **Reconcile required** and the panel says so. Pull again to rebuild it.
</Note>
