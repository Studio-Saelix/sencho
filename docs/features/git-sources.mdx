...
<AccordionGroup>
  ...
  <Accordion title="Branch or tag deleted or force-pushed">
    The configured ref previously resolved to a commit but no longer does on the remote. It may have been deleted, or force-pushed to a history the old commit is no longer part of. Point the source at a current branch, tag, or commit, or restore the ref upstream, then save again.
  </Accordion>
