...
<Frame>
  <img src="/images/pilot-agent/02-enrollment-dialog.png" alt="Enroll the pilot agent modal showing a Docker Compose file with SENCHO_MODE: pilot, SENCHO_PRIMARY_URL, and SENCHO_ENROLL_TOKEN baked in, an Expires 15m from now label, and a Copy button." />
</Frame>
