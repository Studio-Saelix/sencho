...
Network inventory, topology, inspect, and findings live on the dedicated [Networking](/features/networking) page. Resources shows an **Open Networking** card where the Networks tab used to be, and **Quick Clean** still includes **Prune Dead Networks**.
