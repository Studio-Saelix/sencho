...
const sidebarLayoutSrc = read('frontend/src/hooks/use-sidebar-layout.ts');
const anatomyLayoutSrc = read('frontend/src/hooks/use-anatomy-layout.ts');
...
const bSidebarModes = extractArrayLiteral(routeSrc, 'SIDEBAR_MODES');
const bAnatomyModes = extractArrayLiteral(routeSrc, 'ANATOMY_MODES');
...
const fSidebarModes = extractUnionType(sidebarLayoutSrc, 'SidebarMode');
const fAnatomyModes = extractUnionType(anatomyLayoutSrc, 'AnatomyMode');
...
compare('sidebar modes', bSidebarModes, fSidebarModes);
compare('anatomy modes', bAnatomyModes, fAnatomyModes);
